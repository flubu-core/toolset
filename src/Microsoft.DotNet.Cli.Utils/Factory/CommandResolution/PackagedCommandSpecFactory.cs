    ...
    public class PackagedCommandSpecFactory : IPackagedCommandSpecFactory
    {
            ...
            string runtimeConfigPath)
        {
            Reporter.Verbose.WriteLine(string.Format(
                LocalizableStrings2.AttemptingToFindCommand,
            ...
            {
                Reporter.Verbose.WriteLine(string.Format(
                    LocalizableStrings2.FailedToFindToolAssembly,
                    PackagedCommandSpecFactoryName,
                    commandName));
            ...
            {
                Reporter.Verbose.WriteLine(string.Format(
                    LocalizableStrings2.FailedToFindCommandPath,
                    PackagedCommandSpecFactoryName,
                    commandPath));
            ...
            LockFileItem runtimeAssembly)
        {
            ...
            if (packageDirectory == null)
            {
                throw new GracefulException(string.Format(
                    LocalizableStrings2.CommandAssembliesNotFound,
                    toolLibrary.Name));
            }
