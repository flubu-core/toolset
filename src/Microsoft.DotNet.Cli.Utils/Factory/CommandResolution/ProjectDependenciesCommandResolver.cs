    ...
    public class ProjectDependenciesCommandResolver : ICommandResolver
    {
        ...
        public CommandSpec Resolve(CommandResolverArguments commandResolverArguments)
        {
            Reporter.Verbose.WriteLine(string.Format(
                LocalizableStrings2.AttemptingToResolve,
            ...
            {
                Reporter.Verbose.WriteLine(string.Format(
                    LocalizableStrings2.InvalidCommandResolverArguments,
                    ProjectDependenciesCommandResolverName));
            ...
            string buildBasePath)
        {
            ...
            {
                Reporter.Verbose.WriteLine(string.Format(
                    LocalizableStrings2.DidNotFindAMatchingProject,
                    ProjectDependenciesCommandResolverName,
                    projectDirectory));
                return null;
            }
            ...
            {
                Reporter.Verbose.WriteLine(string.Format(
                    LocalizableStrings2.DoesNotExist,
                    ProjectDependenciesCommandResolverName,
                    depsFilePath));
                return null;
            }
            ...
            LockFile lockFile, string commandName, NuGetFramework targetFramework)
        {
            ...
            if (toolLibraries?.Count() > 1)
            {
                throw new InvalidOperationException(string.Format(
                    LocalizableStrings2.AmbiguousCommandName,
                    commandName));
            }

            Reporter.Verbose.WriteLine(string.Format(
                LocalizableStrings2.ToolLibraryFound,
                ProjectDependenciesCommandResolverName,
