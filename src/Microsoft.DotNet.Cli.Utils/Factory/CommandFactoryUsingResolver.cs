...
using System.Linq;
using Microsoft.DotNet.Cli.Utils.Factory.CommandResolution;
using Microsoft.DotNet.CommandFactory;
using NuGet.Frameworks;

namespace Microsoft.DotNet.Cli.Utils.Factory
{
    public static class CommandFactoryUsingResolver
    {
        private static string[] _knownCommandsAvailableAsDotNetTool = new[]
        {
            "dotnet-dev-certs", "dotnet-sql-cache", "dotnet-user-secrets", "dotnet-watch"
        };
        ...
        public static Command Create(CommandSpec commandSpec)
        {
            ...
            {
                FileName = commandSpec.Path, Arguments = commandSpec.Args, UseShellExecute = false
            };
            ...
            var _process = new Process {StartInfo = psi};
